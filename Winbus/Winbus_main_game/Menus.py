...
class Player_card_pick_sub_menu:
    def __init__(self, player: User_team, x_pos):
        ...
        self.ready = False
        self.sound= Sound_manager("Data\SFX")
...
class Deck_builder_menu:
    def __init__(self, display, clock, player_1, player_2, main):
        ...
        self.read_limit= 0
        self.music= Music_manager(r"Data\\Music\\deck_build")
        self.sound= Sound_manager(r"Data\\SFX")
    ...
    def play_menu(self):
        ...
        if self.main.debug:
            quick_display_text(self.display, "Debug mod is activated", "Cyan", (600, 70), size=30)
