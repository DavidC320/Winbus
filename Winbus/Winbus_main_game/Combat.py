...
class Combat:
    def __init__(self, display, clock, player_1: User_team, player_2: User_team, main):
        ...
        self.music = Music_manager("Data\\Music\\battle")
        self.music_r = Music_manager("Data\\Music\\rush")
        self.music_w = Music_manager("Data\\Music\\win")
    ...
    def display_team_units(self):
        for team, deck_pos in ((self.player_1, (300, 700)), (self.player_2, (900, 700))):
            team.display_field_units(self.display, self.current_time, self.main.debug)
